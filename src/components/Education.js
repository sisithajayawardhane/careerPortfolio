        ...
        <div className="Education" style={{ backgroundColor: 'black', minHeight: '100vh' }}>
            <div className="education_cards" >
                <div className='e-card' >
                    ...
                    <div className='uok'>
                        <div className="name-duration" class="flex p-2">
                            <p class="text-2xl font-bold">University of Kelaniya, Sri Lanka</p>
                            <p class="text-sm font-bold m-auto p-1 text-green-600 bg-green-200 rounded-md">2019-present</p>
                        </div>
                ...
                <div className='e-card'>
                    ...
                    <div className='tc'>
                        <div className="name-duration" class="flex p-2">
                            <p class="text-2xl font-bold">Thurstan College, Colombo 3, Sri Lanka</p>
                            <p class="text-sm font-bold m-auto p-1 text-green-600 bg-green-200 rounded-md">2008-2017</p>
                        </div>
